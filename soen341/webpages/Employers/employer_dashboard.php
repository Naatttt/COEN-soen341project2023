...
<html lang="en">
    ...
    <body class="background-image">
        ...
        <div class="profile_buttons">
            <a href="employer_postings.php?query=SELECT+%2A+FROM+postings+WHERE+1%3D1+AND+company+%3D+%27<?php echo $name; ?>%27" class="btn btn-primary btn-lg outer" style="margin-right: 5%; width: 200px">List Postings</a>
