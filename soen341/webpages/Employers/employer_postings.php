...
$query = "SELECT usertype, name, username FROM users WHERE username = '$username'";
    ...
    <body class="background-image">
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<h1 class="text-white" style="font-size: 4vw; margin-bottom: 1%; margin-left: 13.5%">' . $name . ' Postings</h1>';
